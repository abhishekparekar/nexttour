...
const TypingText = ({ text }) => {
  ...
  return (
    <span>
      {displayed}
      <span className="inline-block w-0.5 h-4 bg-[#00C9B7] ml-0.5 align-middle animate-pulse" />
    </span>
  );
};
      ...
      >
        ...
        >
          ...
          <StatItem delay={1.7} target={10000} suffix="+" label="Happy Customers" icon={
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#00C9B7] flex items-center justify-center shadow flex-shrink-0">
