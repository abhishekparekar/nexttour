...
const CTA = () => {
  return (
    <section className="section-padding relative overflow-hidden" style={{ background: 'radial-gradient(circle at 30% 40%, rgba(0, 201, 183, 0.1), transparent 50%), linear-gradient(180deg, #FFFFFF 0%, #F8F9FB 100%)' }}>
      {/* Background Image */}
      ...
      <div className="container-custom relative">
        <motion.div className="max-w-4xl mx-auto text-center" variants={ctaVariants.container} initial="hidden" whileInView="visible" viewport={viewportConfig}>
          ...
          <motion.h2 variants={ctaVariants.content} className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 drop-shadow-xl">
            Ready to Book Your<br /><span className="text-[#00C9B7]">Next Adventure?</span>
          </motion.h2>

          <motion.p variants={ctaVariants.content} className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-10 drop-shadow">
            Don't let the mountains wait. Join thousands of happy travelers who chose NextTour for their <span className="text-[#00C9B7] font-medium">premium</span> adventures.
          </motion.p>
